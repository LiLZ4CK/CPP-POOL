...
/*   Updated: 2022/11/25 22:06:04 by zwalad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char* Bureaucrat::BureaucratLowGrade::what() const throw()
{
...
{
    Bureaucrat::GradeTooHighException L;
    if (form.getEXGrade() >= getGrade())
        std::cout << getName() << " executed " << form.getName() << std::endl;
    else
    {
        std::cout << getName() << " couldn't execut the " << form.getName() << std::endl;
        throw (L);
    }
}