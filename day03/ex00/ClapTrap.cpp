...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/24 18:09:00 by zwalad            #+#    #+#             */
/*   Updated: 2022/11/15 21:38:00 by zwalad           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
    if (this->HitPoints > 0)
    {
        std::cout << this->Name << " |" << this->HitPoints << "| : X_X OUCH!! (-" << amount << ") X_X" << this->HitPoints << std::endl;
